...
global.syzoj = {
  ...
  async run() {
    ...
    console.log(this.untils!=undefined);
    // Set assets dir
    ...
    /*app.use((req,res,next)=>{
      if(req.host!="oj.zhangyiming.tech"){
        res.redirect("https://oj.zhangyiming.tech"+req.originalUrl);
      }
      else{
        next();
      }
