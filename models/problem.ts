...
export default class Problem extends Model {
  ...
  async updateConfig(){
    let obj = {
      ...
      limit_and_hint: this.limit_and_hint,
      time_limit: this.time_limit,
      memory_limit: this.memory_limit,
      have_additional_file: this.additional_file_id != null,
      file_io: this.file_io,
      file_io_input_name: this.file_io_input_name,
      file_io_output_name: this.file_io_output_name,
      type: this.type,
      tags: []
    };
  ...
  async getStatistics(type, paginate) {
    ...
    statistics.prefixSum = statistics.scoreDistribution;
    statistics.suffixSum = statistics.scoreDistribution;
